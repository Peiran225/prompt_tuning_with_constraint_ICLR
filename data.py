...
def load_and_tokenize_data(task, tokenizer,model_name_or_path, data_dir=None):
    ...
    if task=="SST-2":
        ...
        dataset = load_dataset("trec", cache_dir='/fs/cbcb-lab/heng/peiran')
        first_datapoint = dataset['train'][0]
        print(first_datapoint) 
        second_datapoint = dataset['train'][1]
        print(second_datapoint) 
        ...
        reduced_num_train_samples = num_train_samples//4
        dataset['train'] = dataset['train'].select(range(reduced_num_train_samples))
        labels = dataset['train']['label']
        ...
        dataset = load_dataset('super_glue', task)
        num_train_samples = len(dataset['train'])
        reduced_num_train_samples = num_train_samples//2
        dataset['train'] = dataset['train'].select(range(reduced_num_train_samples))
        labels = dataset['train']['label']
